...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA1L3BmLXMxMTEtbW4tY2F1bGlmbG93ZXItYnJvY2NvbGktY2Fycm90LWFwcGxlLXB1cmVlLTAyXzEuanBn.jpg");
...
# LOADING ORDERS
order = pickle.load(open url("https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/orders.pkl","rb"))
...
# RECOMMENDING DISHES FOR REGULAR CUSTOMERS 
    recommended_dishes = pickle.load(open url("https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/recommendations.pkl", "rb"))
...
with et_column:
    ...
    food_list = pickle.load(open url("https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/food.pkl", 'rb'))
    data = pd.DataFrame(food_list)
    similarity = pickle.load(open url("https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/similarity.pkl", 'rb'))
