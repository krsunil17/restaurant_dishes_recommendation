...
# LOADING ORDERS
order = pickle.load(openurl('https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/orders.pkl',"rb"))
...
# RECOMMENDING DISHES FOR REGULAR CUSTOMERS 
    recommended_dishes = pickle.load(openurl('https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/recommendations.pkl', "rb"))
...
with et_column:
    ...
    food_list = pickle.load(openurl('https://github.com/krsunil17/restaurant_dishes_recommendation/blob/rajrrc/food.pkl', 'rb'))
